...
const FoodStock = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Food Stock | Client Portal</title>
      </Helmet>
      <Box
        sx={{
        ...
        <Container maxWidth={false}>
          ...
          >
            ...
            <Dialog open={openAddStock} onClose={handleCloseAddPurchase}>
              <DialogTitle>Add Food Stock</DialogTitle>
              <DialogContent>
                <DialogContentText>
                  Adding a food stock manually will not trigger any
            ...
            <Table>
              <TableHead>
                <TableRow>
                  ...
                  <TableCell>FoodMenu(Code)</TableCell>
                  <TableCell>Category</TableCell>
                  <TableCell>Stock Qty/Amount</TableCell>
                </TableRow>
              </TableHead>
              <TableBody>
                {stocks.length > 0 ? (
