...
const Waste = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Waste | Client Portal</title>
      </Helmet>
      <Box
        sx={{
          ...
          >
            ...
            <div>
              ...
              <Button
                ...
                variant="contained"
                onClick={() => {
                  setRefno(wastes.length + 1);
                  setOpenAddWaste(true);
                }}
              >
                Add Waste
              </Button>
            ...
            <Dialog open={openAddWaste} onClose={handleCloseAddWaste}>
              ...
              <DialogContent>
                <DialogContentText>
                  Adding waste manually will not trigger any notifications or
                  payments. To add a paid order you can create a new invoice and
                  mark it as paid.
                </DialogContentText>
                ...
                {wastes.length > 0 ? (
                  wastes?.map((waste) => (
                    <TableRow hover key={waste.ref_no}>
                      <TableCell style={{}}>{waste.ref_no}</TableCell>

                      <TableCell>{waste.supplier}</TableCell>
                      <TableCell align="right">{waste.total_price}</TableCell>
                      <TableCell align="right">{waste.paid_price}</TableCell>
                      <TableCell align="right">
                        {waste.total_price - waste.paid_price}
                      </TableCell>
                    </TableRow>
                  ))
                ) : (
