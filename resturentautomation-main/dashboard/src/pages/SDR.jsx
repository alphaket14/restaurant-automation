...
const SDR = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Supplier Due Payments | Client Portal</title>
      </Helmet>
      <Box
        sx={{
      ...
      >
        <Container maxWidth={false}>
          ...
          >
            ...
            <Dialog open={openAddSDR} onClose={handleCloseAddSDR}>
              <DialogTitle>Add Supplier Due Payment</DialogTitle>
              <DialogContent>
                <DialogContentText>
                  Adding a supplier payment manually will not trigger any
                  notifications or payments. To add a paid order you can create
                  a new invoice and mark it as paid.
                </DialogContentText>
              ...
              <DialogActions>
                <Button onClick={handleCloseAddSDR}>Cancel</Button>
                <Button
                  onClick={() =>
                    handleAddSDR(
                      SDR.length + 1,
          ...
          <Paper>
            <Table>
              ...
              <TableBody>
                {SDR.length > 0 ? (
                  SDR?.map((SDR) => (
                    <TableRow hover key={SDR.ref_no}>
                      <TableCell style={{}}>{SDR.ref_no}</TableCell>
                      <TableCell>{SDR.supplier}</TableCell>
                      <TableCell align="right">{SDR.total_price}</TableCell>
                      <TableCell align="right">{SDR.paid_price}</TableCell>
                      <TableCell align="right">
                        {SDR.total_price - SDR.paid_price}
                      </TableCell>
                    </TableRow>
                  ))
                ) : (
