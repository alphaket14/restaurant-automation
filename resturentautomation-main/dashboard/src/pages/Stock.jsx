        ...
        <Container maxWidth={false}>
          ...
          >
            ...
            <Dialog open={openAddStock} onClose={handleCloseAddPurchase}>
              ...
              <DialogContent>
                <DialogContentText>
                  Adding a stock manually will not trigger any notifications or
                  payments. To add a paid purchase you can create a new invoice
                  and mark it as paid.
                </DialogContentText>
            ...
            <Table>
              <TableHead>
                <TableRow>
                  ...
                  <TableCell>Qty/Amount</TableCell>
                  <TableCell>Alert Qty/Amount</TableCell>
                </TableRow>
              </TableHead>
              <TableBody>
                {stocks.length > 0 ? (
