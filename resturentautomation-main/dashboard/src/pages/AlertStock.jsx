...
const AlertStock = () => {
  ...
  <>
    <Helmet>
      <title>Alert Stock | Client Portal</title>
    </Helmet>
    <Box
      sx={{
    ...
    >
      <Container maxWidth={false}>
        ...
        >
          ...
          <Button variant="contained" onClick={()=>setOpenAddTransfer(true)}>
            Re-Stock
          </Button>
          <Dialog open={openAddTransfer} onClose={handleCloseAddTransfer}>
                ...
                <DialogContent>
                  <DialogContentText>
                  Adding a stock manually will not trigger any notifications or payments. 
