      ...
      <Container maxWidth={false}>
        ...
        <Paper fullWidth>
          ...
          <div style={{display:"flex", flexDirection:"column", justifyContent:"center"}}>
            ...
            <Button style={{margin:"20px",flex:"0.22", height:"50px",minWidth:"200px"}} variant="contained" onClick={()=>{}}>
              Sign up in TextLocal
             </Button>
            <Button style={{margin:"20px",flex:"0.22", height:"50px",minWidth:"200px"}} variant="contained" onClick={()=>{}}>
              Configure SMS
            </Button>
            ...
            <div style={{width:"100%",display:"flex", flexWrap:"wrap", justifyContent:"center"}}>
            <Button style={{margin:"20px",flex:"0.3", height:"50px",minWidth:"200px"}} variant="contained" onClick={()=>{}}>
              SMS
             </Button>
            <Button style={{margin:"20px",flex:"0.3", height:"50px",minWidth:"200px"}} variant="contained" onClick={()=>{}}>
            SMS Option
