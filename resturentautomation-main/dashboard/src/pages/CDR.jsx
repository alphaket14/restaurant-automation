...
const CDR = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Customer Due Payments | Client Portal</title>
      </Helmet>
      <Box
        sx={{
        ...
        <Container maxWidth={false}>
          ...
          >
            ...
            <Dialog open={openAddCDR} onClose={handleCloseAddCDR}>
              <DialogTitle>Add Customer Due Payment</DialogTitle>
              <DialogContent>
                <DialogContentText>
                  Adding a customer payment manually will not trigger any
            ...
            <Table>
              <TableHead>
                <TableRow>
                  ...
                  <TableCell>Note Added By</TableCell>
                ...
                {CDR.length > 0 ? (
                  CDR?.map((CDR) => (
                    <TableRow hover key={CDR.ref_no}>
                      <TableCell style={{}}>{CDR.ref_no}</TableCell>
                      ...
                      <TableCell align="right">
                        {CDR.total_price - CDR.paid_price}
                      </TableCell>
                    </TableRow>
                  ))
                ) : (
