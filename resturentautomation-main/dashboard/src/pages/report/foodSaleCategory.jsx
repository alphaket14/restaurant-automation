...
const FoodSaleCategoryReport = () => {
  ...
  <>
    <Helmet>
      <title>Food Sale Categories | Client Portal</title>
    </Helmet>
    <Box
      sx={{
      ...
      <Container maxWidth={false}>
        ...
        >
          ...
          <Dialog open={openAddCDR} onClose={handleCloseAddCDR}>
                <DialogTitle>Add Food Sale Category</DialogTitle>
                <DialogContent>
                  <DialogContentText>
                  Adding a food sale category manually will not trigger any notifications or payments. 
...
export default FoodSaleCategoryReport;
