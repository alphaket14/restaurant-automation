...
const FoodSaleReport = () => {
  ...
  <>
    <Helmet>
      <title>Food Sale Report | Client Portal</title>
    </Helmet>
    <Box
      sx={{
      ...
      <Container maxWidth={false}>
        ...
        >
          ...
          <Dialog open={openAddCDR} onClose={handleCloseAddCDR}>
                <DialogTitle>Add Food Sale</DialogTitle>
                <DialogContent>
                  <DialogContentText>
                  Adding a food sale manually will not trigger any notifications or payments. 
