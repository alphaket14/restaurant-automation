...
const KitchenPerformanceReport = () => {
  ...
  <>
    <Helmet>
      <title>Kitchen Performance Report | Client Portal</title>
    </Helmet>
    <Box
      sx={{
      ...
      <Container maxWidth={false}>
        ...
        >
          ...
          <Dialog open={openAddCDR} onClose={handleCloseAddCDR}>
                ...
                <DialogContent>
                  <DialogContentText>
                  Adding a performance manually will not trigger any notifications or payments. 
...
export default KitchenPerformanceReport;
