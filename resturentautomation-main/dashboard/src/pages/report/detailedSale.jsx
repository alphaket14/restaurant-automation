...
const DetailedSaleReport = () => {
  ...
  <>
    <Helmet>
      <title>Detailed Sale | Client Portal</title>
    </Helmet>
    <Box
      sx={{
      ...
      <Container maxWidth={false}>
        ...
        >
          ...
          <Dialog open={openAddCDR} onClose={handleCloseAddCDR}>
                <DialogTitle>Add Detailed Sale</DialogTitle>
                <DialogContent>
                  <DialogContentText>
                  Adding a detailed sale manually will not trigger any notifications or payments. 
