...
const SupplierDueReport = () => {
  ...
  <>
    <Helmet>
      <title>Supplier Dues Report| Client Portal</title>
    </Helmet>
    <Box
      sx={{
      ...
      <Container maxWidth={false}>
        ...
        >
          ...
          <Dialog open={openAddCDR} onClose={handleCloseAddCDR}>
                <DialogTitle>Add Supplier Due</DialogTitle>
                <DialogContent>
                  <DialogContentText>
                  Adding a supplier due manually will not trigger any notifications or payments. 
