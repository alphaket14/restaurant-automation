...
const ProfitLossReport = () => {
  ...
  <>
    <Helmet>
      <title>Profit/Loss Report | Client Portal</title>
    </Helmet>
    <Box
      sx={{
      ...
      <Container maxWidth={false}>
        ...
        >
          ...
          <Dialog open={openAddCDR} onClose={handleCloseAddCDR}>
                <DialogTitle>Add Profit/Loss</DialogTitle>
                <DialogContent>
                  <DialogContentText>
                  Adding a profit or loss manually will not trigger any notifications or payments. 
