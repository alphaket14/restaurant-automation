...
const FoodTransferReport = () => {
  ...
  <>
    <Helmet>
      <title>Food Transfer Report | Client Portal</title>
    </Helmet>
    <Box
      sx={{
      ...
      <Container maxWidth={false}>
        ...
        >
          ...
          <Dialog open={openAddCDR} onClose={handleCloseAddCDR}>
                <DialogTitle>Add Food Transfer</DialogTitle>
                <DialogContent>
                  <DialogContentText>
                  Adding a food transfer manually will not trigger any notifications or payments. 
...
export default FoodTransferReport;
