...
const Attendance = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Attendance | Client Portal</title>
      </Helmet>
      <Box
        sx={{
      ...
      >
        <Container maxWidth={false}>
          ...
          >
            ...
            <Dialog open={openAddAttendance} onClose={handleCloseAddAttendance}>
              <DialogTitle>Add Attendance</DialogTitle>
              <DialogContent>
                <DialogContentText>
                  Adding an attendance manually will not trigger any
              ...
              <DialogActions>
                <Button onClick={handleCloseAddAttendance}>Cancel</Button>
                <Button
                  onClick={() =>
                    handleAddAttendance(
                      Attendance.length + 1,
              ...
              <TableBody>
                {Attendance.length > 0 ? (
                  Attendance?.map((Attendance) => (
                    <TableRow hover key={Attendance.ref_no}>
                      <TableCell style={{}}>{Attendance.ref_no}</TableCell>

                      <TableCell>{Attendance.supplier}</TableCell>
                      <TableCell align="right">
                        {Attendance.total_price}
                      </TableCell>
                      <TableCell align="right">
                        {Attendance.paid_price}
                      </TableCell>
                      <TableCell align="right">
                        {Attendance.total_price - Attendance.paid_price}
                      </TableCell>
                    </TableRow>
                  ))
                ) : (
