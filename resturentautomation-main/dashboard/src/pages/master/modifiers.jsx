...
const ModifiersMaster = () => {
  ...
  <>
    <Helmet>
      <title>Modifiers | Client Portal</title>
    </Helmet>
    <Box
      sx={{
      ...
      <Container maxWidth={false}>
        ...
        >
          ...
          <Dialog open={openAddCDR} onClose={handleCloseAddCDR}>
                ...
                <DialogContent>
                  <DialogContentText>
                  Adding a modifier manually will not trigger any notifications or payments. 
...
export default ModifiersMaster;
