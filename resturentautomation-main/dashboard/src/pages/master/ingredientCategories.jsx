...
const IngredientCategoriesMaster = () => {
  ...
  <>
    <Helmet>
      <title>Ingredient Categories | Client Portal</title>
    </Helmet>
    <Box
      sx={{
      ...
      <Container maxWidth={false}>
        ...
        >
          ...
          <Dialog open={openAddCDR} onClose={handleCloseAddCDR}>
                ...
                <DialogContent>
                  <DialogContentText>
                  Adding an ingredient category manually will not trigger any notifications or payments. 
...
export default IngredientCategoriesMaster;
