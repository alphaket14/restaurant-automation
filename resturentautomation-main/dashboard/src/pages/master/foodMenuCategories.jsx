...
const FoodMenuCategoriesMaster = () => {
  ...
  <>
    <Helmet>
      <title>Food Menu Category | Client Portal</title>
    </Helmet>
    <Box
      sx={{
      ...
      <Container maxWidth={false}>
        ...
        >
          ...
          <Dialog open={openAddCDR} onClose={handleCloseAddCDR}>
                <DialogTitle>Add Food Menu Category</DialogTitle>
                <DialogContent>
                  <DialogContentText>
                  Adding a food menu category manually will not trigger any notifications or payments. 
...
export default FoodMenuCategoriesMaster;
