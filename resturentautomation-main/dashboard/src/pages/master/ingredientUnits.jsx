...
const IngredientsUnitMaster = () => {
  ...
  <>
    <Helmet>
      <title>Ingredients Units | Client Portal</title>
    </Helmet>
    <Box
      sx={{
      ...
      <Container maxWidth={false}>
        ...
        >
          ...
          <Dialog open={openAddCDR} onClose={handleCloseAddCDR}>
                ...
                <DialogContent>
                  <DialogContentText>
                  Adding a customer payment manually will not trigger any notifications or payments. 
...
export default IngredientsUnitMaster;
