...
const ExpenseItemsMaster = () => {
  ...
  <>
    <Helmet>
      <title>Expense Items | Client Portal</title>
    </Helmet>
    <Box
      sx={{
      ...
      <Container maxWidth={false}>
        ...
        >
          ...
          <Dialog open={openAddCDR} onClose={handleCloseAddCDR}>
                ...
                <DialogContent>
                  <DialogContentText>
                  Adding a expense item manually will not trigger any notifications or payments. 
...
export default ExpenseItemsMaster;
