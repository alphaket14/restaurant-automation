...
const FoodMenusMaster = () => {
  ...
  <>
    <Helmet>
      <title>Food Menus | Client Portal</title>
    </Helmet>
    <Box
      sx={{
      ...
      <Container maxWidth={false}>
        ...
        >
          ...
          <Dialog open={openAddCDR} onClose={handleCloseAddCDR}>
                ...
                <DialogContent>
                  <DialogContentText>
                  Adding a food menu manually will not trigger any notifications or payments. 
...
export default FoodMenusMaster;
