...
const createData = (sl, department, designation, Overtime_hour, overtime_rate, period, status, action) => {
  return { sl, department, designation, Overtime_hour, overtime_rate, period, status, action };
};

const data = [
  createData(1, "Accounts", "Manager", 2, "100", "Monthly", "Enabled"),
  createData(2, "Accounts", "Manager", 2, "100", "Monthly", "Enabled"),
  createData(3, "Accounts", "Manager", 2, "100", "Monthly", "Enabled"),
  createData(4, "Accounts", "Manager", 2, "100", "Monthly", "Enabled"),
  createData(5, "Accounts", "Manager", 2, "100", "Monthly", "Enabled")
];
...
const CommissionSetting = (props) => {
  ...
  const columns = [
    ...
    { label: "Overtime Hour", minWidth: 100, maxWidth: 350 },
    { label: "Overtime Rate/hr", minWidth: 100, maxWidth: 350 },
    ...
    <Fade in={openModal}>
      <Box className={classes.modal}>
        ...
        <Grid item container direction="column" spacing={2} sx={{ padding: 2 }}>
          ...
          <Grid item container>
            <Grid item xs={4}>
              <Typography variant="subtitle2">Overtime Hour :</Typography>
            </Grid>
            <Grid item xs={8}>
              <TextField fullWidth size="small"
                value={commision}
          ...
          <Grid item container>
            <Grid item xs={4}>
              <Typography variant="subtitle2">Overtime Rate :</Typography>
            </Grid>
            <Grid item xs={8}>
              <TextField fullWidth size="small"
                value={commision}
            ...
            {rows.map((row,id) => {
              return (
                <TableRow key={row.sl} hover>
                  ...
                  <TableCell style={{ textAlign: "center"}}>{row.Overtime_hour}</TableCell>
                  <TableCell style={{ textAlign: "center"}}><CurrencyRupee fontSize="small" style={{color:"gray", marginRight:"5px"}}/>{row.overtime_rate}</TableCell>
