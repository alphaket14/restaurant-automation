...
const createData = (sl, department, designation, target, achievement, commision, period, status, action) => {
  return { sl, department, designation, target, achievement, commision, period, status, action };
};

const data = [
  createData(1, "Accounts", "Manager", 200, 500, 100, "Monthly", "Enabled"),
  createData(2, "Accounts", "Manager", 200, 500, 100, "Monthly", "Enabled"),
  createData(3, "Accounts", "Manager", 200, 500, 100, "Monthly", "Enabled"),
  createData(4, "Accounts", "Manager", 200, 500, 100, "Monthly", "Enabled"),
  createData(5, "Accounts", "Manager", 200, 500, 100, "Monthly", "Enabled")
];
...
const CommissionSetting = (props) => {
  ...
  const columns = [
    ...
    { label: "Target", minWidth: 100, maxWidth: 350 },
    { label: "Achievement", minWidth: 100, maxWidth: 350 },
    { label: "Commission ", minWidth: 100, maxWidth: 350 },
            ...
            {rows.map((row,id) => {
              return (
                <TableRow key={row.sl} hover>
                  ...
                  <TableCell style={{ textAlign: "center"}}><CurrencyRupee fontSize="small" style={{color:"gray", marginRight:"5px"}}/>{row.target}</TableCell>
                  <TableCell style={{ textAlign: "center"}}><CurrencyRupee fontSize="small" style={{color:"gray", marginRight:"5px"}}/>{row.achievement}</TableCell>
                  <TableCell style={{ textAlign: "center"}}><CurrencyRupee fontSize="small" style={{color:"gray", marginRight:"5px"}}/>{row.commision}</TableCell>
