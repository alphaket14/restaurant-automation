...
const ReservationSettingDayWise = (props) => {
  ...
  const columns = [
    ...
    { label: "Max Reserved Person", minWidth: 100, maxWidth: 100 },
    { label: "Actions", minWidth: 100, maxWidth: 150 }
  ];

  const createRows = (startTime, endTime, max) => ({ startTime, endTime, max });

  const rows = [createRows("10:00", "11:00", 20), createRows("14:00", "15:00", 8)];
...
export default ReservationSettingDayWise;
