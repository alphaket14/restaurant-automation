...
const PendingOrders = () => {
  ...
  const columns = [
    { label: "Order No.", minWidth: 100, maxWidth: 150},
    { label: "Inv No.", minWidth: 100, maxWidth: 150},
    { label: "Name", minWidth: 100, maxWidth: 150},
    { label: "Phone", minWidth: 100, maxWidth: 150},
    { label: "Waiter", minWidth: 100, maxWidth: 150},
    { label: "Table", minWidth: 100, maxWidth: 150},
    { label: "Order Date", minWidth: 100, maxWidth: 150},
    {
      label: "Amount",
  ...
  const deliveryColumns = [
    ...
    { label: "Order Date", minWidth: 50, maxWidth: 150},
    {
      label: "Amount",
      endIcon: <CurrencyRupee sx={{ fontSize: 14 }} />,
      minWidth: 50,
    ...
    <Box style={{ margin: 0 }}>
      ...
      <Stack direction="row" alignItems="center" justifyContent="space-between" sx={{ mb: 1 }}>
        ...
        <Box component="span" sx={{
          ...
          <FormControl sx={{ mr: 1, float: "left", width:"20%",mb: 2  }}size="small">
      ...
      <Box sx={{ width: "50%", mb: 1 }}>
        <TextField label="Search" size="small" sx={{ width: "50%", mb: 1 }} fullWidth />
      </Box> */}
      <Box>
        {type === "Dine In" ? (
            <Grid
