...
const ManageStoreTime = (props) => {
  const columns = [
    { label: "Sr. No.", minWidth: 50, maxWidth: 70 },
    { label: "Day Name", minWidth: 250, maxWidth: 350 },
    { label: "Opening Time", minWidth: 150, maxWidth: 300 },
    { label: "Closing Time", minWidth: 150, maxWidth: 300 },
    { label: "Action", minWidth: 20, maxWidth: 50 }
  ];

  const createData = (sl, dayName, openTime, closeTime, action) => {
    return { sl, dayName, openTime, closeTime, action };
  };

  const rows = [createData(1, "Saturday", "08:00", "02.00", "dummy")];
