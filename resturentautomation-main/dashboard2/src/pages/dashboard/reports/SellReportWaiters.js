...
const SellReportWaiters = (props) => {
  const columns = [
    ...
    { label: "Waiter Name", minWidth: 50, maxWidth: 100 },
  ...
  const createRows = (orderType, orderNo, invNo, orders, waiterName, totAmount) => ({
    orderType,
    orderNo,
    invNo,
    orders,
  ...
  const rows = [createRows("Dine In", 45, 123, 45, "Waiter Name", 5200)];
...
export default SellReportWaiters;
