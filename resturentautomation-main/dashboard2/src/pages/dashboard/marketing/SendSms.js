    ...
    >
      ...
      <Grid item container style={{ padding: "20px 20px" }}>
        <Grid item container direction="column" rowGap={2}>
          ...
          <Grid item container spacing={3}>
            <Grid item xs={3} align="right">
              <Typography variant="body1">Phone No. from Group :</Typography>
            </Grid>
            <Grid item xs={8}>
    ...
    <>
      <Grid container sx={{ mb: 2 }} spacing={2}>
        <Grid item xs={3}>
          ...
          >
            <Typography variant="body1">Total SMS Balance</Typography>
        ...
        <Grid item xs={3}>
          ...
          >
            <Typography variant="body1">Total SMS Sent</Typography>
        ...
        <Grid item xs={3}>
          ...
          >
            <Typography variant="body1">Total SMS Consumed</Typography>
        ...
        <Grid item xs={3}>
          ...
          >
            <Typography variant="body1">Total SMS Delivered</Typography>
        ...
        <Grid item xs={3}>
          ...
          >
            <Typography variant="body1">Total SMS Failed</Typography>
