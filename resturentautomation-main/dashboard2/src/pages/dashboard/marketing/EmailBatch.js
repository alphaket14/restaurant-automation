...
const EmailBatch = (props) => {
  const navigate = useNavigate();
  const columns = [
    { label: "Sr. No.", minWidth: 50, maxWidth: 100 },
    { label: "Batch No.", minWidth: 50, maxWidth: 100 },
    { label: "Total Email", minWidth: 50, maxWidth: 100 },
    { label: "Successful Email", minWidth: 50, maxWidth: 100 },
    { label: "Failed Email", minWidth: 50, maxWidth: 100 },
    { label: "Sender", minWidth: 50, maxWidth: 100 },
    { label: "Status", minWidth: 50, maxWidth: 100 },
    { label: "Actions", minWidth: 20, maxWidth: 50 }
  ];

  const createRows = (batch, totEmail, successEmail, failedEmail, sender, status) => ({
    batch,
    totEmail,
    successEmail,
    failedEmail,
  ...
  const rows = [createRows("SB-118", 3, 0, 3, "PHP", "Completed")];
  ...
  return (
    <>
      ...
      >
        {/* <Typography variant="h5">Email Batch</Typography> */}
      </Box>
            ...
            <TableBody>
              {rows.map((row, id) => (
                <TableRow>
                  ...
                  <TableCell align="center">{row.totEmail}</TableCell>
                  <TableCell align="center">{row.successEmail}</TableCell>
                  <TableCell align="center">{row.failedEmail}</TableCell>
