...
const CreditVoucherAccount = (props) => {
  const [rows,setRows] = useState(data);

  const columns = [
    { label: "Account Name", minWidth: 100, maxWidth: 200 },
        ...
        <Grid item container style={{ padding: "20px 20px" }}>
          <Grid item container direction="column" xs={6} rowGap={2}>
            <Grid item container spacing={3}>
              ...
              <Grid item xs={8}>
                <TextField size="small" placeholder="DV-3" fullWidth />
              </Grid>
            </Grid>
            <Grid item container spacing={3}>
              <Grid item xs={4} align="right">
...
export default CreditVoucherAccount;
