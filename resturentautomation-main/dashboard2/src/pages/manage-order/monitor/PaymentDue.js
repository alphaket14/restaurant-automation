...
const PaymentDue = (props) => {
  ...
  useEffect(() => {
    const fetchdata = async () => {
      ...
      const order = await axios.get('https://vast-pink-meerkat-suit.cyclic.app/order/paymentdueorders');
      ...
      const sectionWiseCount = await axios.get('https://vast-pink-meerkat-suit.cyclic.app/table/paymentduecount');
          ...
          <Grid container direction="column" justifyContent="space-between">
            ...
            <Grid item sx={{ mt: 1 }}>
              <Grid item container direction="column" rowSpacing={2}>
                ...
                <Grid fullWidth item>
                  <Button fullWidth variant="outlined" color="secondary" component={NavLink} to='/manageorder/booked-table' >
