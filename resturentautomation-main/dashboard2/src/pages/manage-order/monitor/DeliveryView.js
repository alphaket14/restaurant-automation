...
const DeliveryView = (props) => {
  const instructions = [
    ...
    { label: "Orders Delivered", color: "primary.light" },
  ...
  return (
    <>
            ...
            <Grid container direction="column" rowSpacing={2}>
              <Grid item container>
                <Grid item container xs={4} direction="column" rowSpacing={1}>
                  <Grid item>Order Type : Delivery</Grid>
                  <Grid item>Delivery Boy : Captain</Grid>
                </Grid>
                <Grid item container xs={4} direction="column" rowSpacing={1}>
                ...
                <Grid item container xs={4} direction="column" rowSpacing={1}>
                  ...
                  <Grid item>Pin Code : 123456</Grid>
                </Grid>
              </Grid>
              <Grid item>
      ...
      <Grid container>
        {/* side menu */}
        <Grid item container mt={1} xs={2} direction="column" sx={{ padding: 2 }} rowSpacing={2}>
          <Grid fullWidth item>
            <Button
              fullWidth
              variant="outlined"
          ...
          <Grid fullWidth item>
            <Button fullWidth variant="contained" component={NavLink} to="/manageorder/delivery-view">
              Delivery
            </Button>
          </Grid>
          <Grid fullWidth item>
            <Button fullWidth variant="outlined" component={NavLink} to="/manageorder/pickup-view">
              Pick Up
            </Button>
          </Grid>
        </Grid>
