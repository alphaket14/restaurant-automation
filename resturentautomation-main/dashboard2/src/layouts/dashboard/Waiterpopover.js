...
import { Getwaiterdatabyid } from "src/redux/Waiter api/WaiterAuthApi";
...
export default function WaiterAccountPopover() {
      ...
      >
        <Box sx={{ my: 1.5, px: 2.5 }}>
          <Typography variant="subtitle1" noWrap>
            {data1 && data1.firstName + data1.lastName}
          </Typography>
