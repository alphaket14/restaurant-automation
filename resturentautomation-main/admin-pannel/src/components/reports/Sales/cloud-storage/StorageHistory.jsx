...
const createRow = (id,plan, startDate,endDate,storage,balance,paymentMode,discount,tax, serviceFees, amount) => ({id,plan, startDate,endDate,storage,balance,paymentMode,discount,tax, serviceFees, amount});

const rows = [
    createRow(1,"Plan","25-08-2022","26-10-2022","storage","Balance","Mode",100,20,100,500)
]

function StorageHistory(){
  return(
    <div>
    <Title title="Storage History"/>
    <br/>
    ...
    <Table title="Storage History" rows={rows} columns={columns} height={390} rowsPerPage={5}/>
    </div>
  )
}
