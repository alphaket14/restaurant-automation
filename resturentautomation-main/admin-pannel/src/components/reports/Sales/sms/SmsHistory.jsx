...
const createRow = (id,plan, startDate,endDate,sms,balance,paymentMode,discount,tax, serviceFees, amount) => ({id,plan, startDate,endDate,sms,balance,paymentMode,discount,tax, serviceFees, amount});

const rows = [
    createRow(1,"Plan","25-08-2022","26-10-2022","Sms","Balance","Mode",100,20,100,500)
]

function SmsHistory(){
  return(
    <div>
    <Title title="Sms History"/>
    <br/>
    ...
    <Table title="Sms History" rows={rows} columns={columns} height={390} rowsPerPage={5}/>
    </div>
  )
}
