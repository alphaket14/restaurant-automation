  ...
  renderCell: () => {
    return (
      <ActionButton label={"Action"} dropDown={[
        ...
        {label:"Block"},
        {label:"Refund"},
        {label:"History", path:"/reports-sms-history"},
      ]}/>
    );
  },
  width: 150,
...
function SmsSales(){
  return(
    <div>
    <Title title="Sms Sales"/>
    <br/>
    
    {/*passing fullscreen component tool as prop in taskbar component*/}
    <Table title="Sms Sales" rows={rows} columns={columns} height={390} rowsPerPage={5}/>
    </div>
  )
}
export default SmsSales;