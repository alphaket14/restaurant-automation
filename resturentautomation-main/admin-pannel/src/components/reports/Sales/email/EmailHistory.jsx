...
const createRow = (id,plan, startDate,endDate,email,balance,paymentMode,discount,tax, serviceFees, amount) => ({id,plan, startDate,endDate,email,balance,paymentMode,discount,tax, serviceFees, amount});

const rows = [
    createRow(1,"Plan","25-08-2022","26-10-2022","email","Balance","Mode",100,20,100,500)
]

function EmailHistory(){
  return(
    <div>
    <Title title="Email History"/>
    <br/>
    ...
    <Table title="Email History" rows={rows} columns={columns} height={390} rowsPerPage={5}/>
    </div>
  )
}
