...
function WalletsTransaction(){
  return(
    <div>
    <Title title="Wallets Transaction"/>
    <br/>
    ...
    <Table transaction paymentModes={["PayTm","PhonePe","Google Pay"]} title="Wallets Transaction" rows={rows} columns={columns} height={390} rowsPerPage={5}/>
    </div>
  )
}
