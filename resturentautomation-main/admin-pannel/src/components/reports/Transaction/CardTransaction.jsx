...
const rows = [
    createRow(1,"29-08-2022","ID","Order ID","Invoice","Dine In","Debit Card",500,"Completed")
]

function CardTransaction(){
  return(
    <div>
    <Title title="Card Transaction"/>
    <br/>
    ...
    <Table transaction paymentModes={["Credit Card","Debit Card"]} title="Card Transaction" rows={rows} columns={columns} height={390} rowsPerPage={5}/>
    </div>
  )
}
