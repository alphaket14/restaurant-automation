...
function AllTransaction(){
  return(
    ...
    <Table transaction paymentModes={["Cash","Card","UPI","Wallets","Others"]} title="All Transaction" rows={rows} columns={columns} height={390} rowsPerPage={5}/>
    </div>
  )
}
