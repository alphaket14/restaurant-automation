...
function OtherTransaction(){
  return(
    ...
    <Table transaction paymentModes={["PayTm","PhonePe","Google Pay"]} title="Other Transaction" rows={rows} columns={columns} height={390} rowsPerPage={5}/>
    </div>
  )
}
