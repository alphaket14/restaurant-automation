...
const rows = [
    createRow(1,"29-08-2022","ID","Order ID","Invoice","Dine In","Cash",500,"Completed")
]

function CashTransaction(){
  return(
    <div>
    <Title title="Cash Transaction"/>
    <br/>
    ...
    <Table transaction paymentModes={["Cash","Cash On Delivery","Online COD",]} title="Cash Transaction" rows={rows} columns={columns} height={390} rowsPerPage={5}/>
    </div>
  )
}
